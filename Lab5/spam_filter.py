...
predict_labels_train = NB.predict_proba(X_train)
recall_train = NB.score(y_train, predict_labels_train['predict'])
print("recall train of NB: ", recall_train)

#=========Testing the Naive Bayes======	
predict_labels_test = NB.predict_proba(X_test)
recall_test = NB.score(y_test, predict_labels_test['predict'])
